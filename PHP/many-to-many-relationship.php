...
$enrolled_courses_query = "SELECT c.course_id, c.fees, e.result
                           FROM studentcoursesnormalized c
                           JOIN enrollmentsnormalized e ON c.course_id = e.course_id
                           WHERE e.student_id = ?";
...
<body>
    ...
    <aside class="sidebar p-4">
        <ul class="list-unstyled">
            <!-- Navigation Links -->
          <!--  <li><a href="studentcourses.php" class="text-white"></a></li>
            <li><a href="studentresults.php" class="text-white"></a></li>
            <li><a href="studentfees.php" class="text-white"></a></li>
            <li><a href="studentlibrary.php" class="text-white"></a></li>
            <li><a href="studentenrolment.php" class="text-white"></a></li> -->
        </ul>
    </aside>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                        ...
                        echo '<tr><td colspan="3"><strong>Student Information</strong></td></tr>';
                        echo '<tr><td colspan="3">Welcome, ' . $_SESSION['student_name'] . '<br>Student ID: ' . $_SESSION['student_id'] . '<br>Email: ' . $_SESSION['student_email'] . '</td></tr>';

                        // Display enrolled courses and results
                        foreach ($enrolled_courses as $course) {
                            echo '<tr><td>' . $course['course_id'] . '</td><td>' . $course['fees'] . '</td><td>' . $course['result'] . '</td></tr>';
                        }
                    ?>
                </tbody>
            </table>
